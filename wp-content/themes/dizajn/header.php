...
<svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
    ...
    <symbol id="i-twitter"   viewBox="0 0 24 24" fill="currentColor" stroke="none"><path d="M19 0c2.743 0 5 2.257 5 5v14c0 2.743-2.257 5-5 5H5c-2.743 0-5-2.257-5-5V5c0-2.743 2.257-5 5-5h14ZM4.815 5.243l5.575 7.454-5.61 6.06h1.263l4.911-5.306 3.969 5.306h4.297l-5.889-7.873 5.222-5.641H17.29l-4.523 4.886-3.655-4.886H4.815Zm1.857.93h1.974l8.717 11.654h-1.974L6.672 6.173Z" /></symbol>
    ...
    <symbol id="i-twitter-share"   viewBox="0 0 24 24" fill="currentColor" stroke="none"><path d="m2.27 2.849 7.55 10.095-7.598 8.207h1.71l6.652-7.186 5.375 7.186h5.819L13.803 10.49l7.072-7.64h-1.71l-6.126 6.618-4.95-6.618H2.27Zm2.515 1.26h2.673l11.805 15.783h-2.674L4.785 4.108Z" /></symbol>
...
<?php
$homeTags = get_theme_mod( 'home_tags-sort' );
if(count($homeTags) > 0):
?>
    ...
    <div class="subheader">
        <div class="slider-featags swiffy-slider slider-item-reveal slider-item-nogap slider-item-snapstart slider-item-nosnap-touch slider-nav-scrollbar slider-nav-visible slider-nav-touch slider-nav-autoplay slider-nav-autopause slider-indicators-square">
            <ul class="slider-container">
                <?php foreach ($homeTags as $tag): ?>
                    <li><a href="<?php echo esc_url($tag['link']) ?>"><?php echo $tag['naziv'] ?></a></li>
                <?php endforeach; ?>
            </ul>
        </div>
    </div>
